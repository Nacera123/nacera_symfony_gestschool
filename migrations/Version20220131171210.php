 ...
 */
final class Version20220131171210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_1D1C63B324351654 ON utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1D1C63B324351654 ON utilisateur (typeutilisateur_id)');
    }
}
